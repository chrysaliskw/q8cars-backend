...
Your Bank Suggestion has been Submitted!

Dear {{ $suggested_bank->first_name }} {{ $suggested_bank->last_name }},

We are pleased to inform you that your bank suggestion has been submitted.
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="background-color: #fff;padding:15px;text-align:center;">
                                    <h1>Bank Suggestion Request Submitted</h1>
                                </td>
                            </tr>
                                ...
                                <td style="padding-bottom: 40px;">
                                    <table width="300" style="border-spacing: 0;background-color:#F9F9F9;padding:12px;">
                                        ...
                                        <td width="200" style="padding-left:20px;">
                                             ...
                                             Hi <b>{{ $suggested_bank['first_name'] }} {{ $suggested_bank['last_name'] }},

                                             We are pleased to inform you that your bank suggestion for {{ $suggested_bank['bank_name'] }} has been submitted.
