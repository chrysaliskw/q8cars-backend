<x-admin-layout title="User Reports">
    ...
    <x-crud-create cardTitle="Create User Report">
        <form method="GET" class="form-horizontal" action="{{ route('admin.reports.user.index') }}">
            <div class="row">
                <div class="col-md-4">
                    <x-form-input type="text" field="name" field-name="Name" value="<?php echo isset($_GET['name']) ? $_GET['name'] : ''; ?>"></x-form-input>
                </div>
                ...
                <div class="col-md-9">
                    <div class="d-flex align-items-center" style="height:100%;padding:0 10px;">
                        ...
                        <div class="action-item-button">
                            <a href="{{route('admin.reports.user.index')}}" class="btn btn-primary waves-effect waves-light">Reset</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-crud-index title="User Reports">
        <div class="row">
            <div class="col-lg-12">
                {!! $grid->render() !!}
            </div>
