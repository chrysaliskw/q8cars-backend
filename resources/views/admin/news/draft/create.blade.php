<x-admin-layout title="Drafted News">
    ...
    <x-slot name="breadcrumb">
        ...
        <li><a href="{{ route('admin.news.draft.index') }}">Draft News</a></li>
    ...
    {{-- <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb pull-right">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.news.draft.index') }}">News</a></li>
                    <li class="active">Create</li>
                </ol>
            </div>
        </div> --}}
    ...
    <x-crud-create title="News">
        <x-form method="POST" action="{{ route('admin.news.draft.store') }}" class="form" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-4">
                    <x-form-select field="language" field-name="Language" defaultPrompt="Select language">
                        @foreach (config('params.news.draft.language') as $value => $label)
                            <option {{ old('language') == $value ? 'Selected' : '' }} value="{{ $value }}">
                                {{ $label }}</option>
                        @endforeach
                    </x-form-select>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <x-form-input type="file" field="author_image" field-name="Author Image (maximum limit : 2MB)"
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- <label for="content">Content</label> -->
                    <!-- <textarea name="content" id="content"  rows="9" onkeyup="textArea(event)">{{ old('content') }}</textarea> -->
                   <!-- <x-form-textarea field="content" field-name="Content" field-value="{{ old('content') }}" id="content" onclick="textArea()">
                    </x-form-textarea> -->
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="form-check form-check-inline col-md-4">
                            <input class="form-check-input" type="checkbox" name="all_countries" id="all_countries"
                                value="-1" onclick="selectAllCountries()">
