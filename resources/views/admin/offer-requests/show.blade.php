            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="card card-border card-primary">
                    <div class="card-header">
                        <div class="m-b-30">
                        <div class="m-b-30">
                            @if($offerRequest->status != \App\Models\OfferRequest::STATUS_COMPLETED)
                        <button 
                            onclick="openUpdateStatusModal(this)" 
                            data-id="{{ $offerRequest->id }}" 
                            data-status="{{ $offerRequest->status }}" 
    ...
    <x-slot name="scripts">
        <script>
            ...
            function submitStatusUpdate() 
            {
                ...
                fetch('{{ route('admin.offer-requests.update') }}', {
                    method: 'POST',
                    body: formData,
                    headers: {
