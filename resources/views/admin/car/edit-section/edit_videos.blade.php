...
<div id="form-sections-container">
    ...
    <div class="row form-section" id="form-section-{{ $key + 1 }}">
        <div class="col-md-4">
            <x-form-input type="text" field="title_{{ $key + 1 }}" field-name="Title" value="{{ $carVideo->video_title }}"></x-form-input>
        </div>
        <div class="col-md-4">
            <x-form-textarea type="text" field="description_{{ $key + 1 }}" field-name="Description" field-value="{{ $carVideo->video_description }}"></x-form-textarea>
        </div>
        <div class="col-md-4">
            <x-form-input type="text" field="posted_media_{{ $key + 1 }}" field-name="Posted Media" value="{{ $carVideo->video_posted_media }}"></x-form-input>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <img src="{{ file_asset('files-car', $carVideo->thumbnail) }}" alt="brand-img" class="img-thumbnail" width="100" height="150">
                @endif
        ...
        <div class="col-md-4">
            <x-form-input type="file" field="video_{{ $key + 1 }}" field-name="Video File" value=""></x-form-input>
