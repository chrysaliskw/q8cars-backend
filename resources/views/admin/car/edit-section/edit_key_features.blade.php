    ...
    <div class="card-body">
        <div class="row">
          ...
          {{--  <div class="col-md-4">
            ...
            <div class="col-md-4">
                <x-form-input type="text" field="engine_capacity" field-name="Engine Displacement" value="{{ $carVarient->engine_capacity }}">
                </x-form-input>
            </div>
            <div class="col-md-4">
                <x-form-input type="text" field="power" field-name="Power(hp)" value="{{ $carVarient->power }}">
                </x-form-input>
            </div>
            <div class="col-md-4">
                <x-form-input type="text" field="torque" field-name="Torque(nm)" value="{{ $carVarient->torque }}">
                </x-form-input>
            </div>
...
<div class="card card-border card-primary">
    ...
    <div class="card-body">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <x-form-input type="text" field="fuel_tank_capacity" field-name="Fuel Tank Capacity(L/KW)" value="{{ $carVarient->fuel_tank_capacity }}">
                </x-form-input>
            </div>
         {{--   <div class="col-md-4">
            ...
            <div class="col-md-4">
                <x-form-input type="text" field="mileage" field-name="Mileage(Kmpl/kwh)" value="{{ $carVarient->mileage }}">
                </x-form-input>
            </div>
            {{-- <div class="col-md-4">
            ...
            <div class="col-md-4">
                <x-form-select field="view_camera" field-name="360 view*" defaultPrompt="Select">
                    @foreach (config('params.car.view-camera') as $value => $label)
                        <option value="{{ $value }}" {{ (old('view_camera', $carVarient->view_camera) == $value) ? 'selected' : '' }}>
                            {{ $label }}
                        </option>
                    @endforeach
                </x-form-select>
