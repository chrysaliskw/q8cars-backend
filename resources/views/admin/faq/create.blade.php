<x-admin-layout title="FAQ">
    ...
    <x-crud-create title="FAQ">
        <x-form method="POST" action="{{ route('admin.faq.store') }}" class="form">
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row">   
                <div class="col-md-12">
                    <x-form-textarea field="question" field-name="Question" field-value="{{ old('question') }}"></x-form-textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <textarea class="summernote form-control" rows="9" name="answer">{{ old('answer') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div> 
            ...
            <div class="row">  
                <div class="col-md-4">
                    <x-form-input field="sort_order" field-name="Sort Order" value="{{ old('sort_order') }}"></x-form-input>
                </div>
                <div class="col-md-4">
