...
class ZebraImageService {
    ...
    public function crop($start_x, $start_y, $end_x, $end_y, $background_color = -1) {
        ...
        if ($result !== false) {
            dd("inside if");
            // co  dd("inside else");mpute width and height
            $width = $end_x - $start_x;
    ...
    private function _create_from_source() {
        ...
        if (!function_exists('gd_info')) {
            dd("if the GD library is not installed");
        ...
        // elseif (!file_exists_in_s3($this->source_path)) {
        ...
        //     dd("if source file does not exist");
        //     // save the error level and stop the execution of the script
        //     $this->error = 2;
        ...
        // } 
            ...
            //Mindster edit handle .tmp extension
            if(strtolower($this->target_type) == 'tmp'){
