...
class OfferController extends Controller
{
    ...
    public function show(Offer $offer)
    {
        ...
        $viewData = [
            ...
            'Key Feature 1' => empty($offer->html_key_feature_1) ? 'NIL' : $offer->html_key_feature_1,
            'Key Icon 1' => $offer->key_icon_1,
            'Key Feature 2' => empty($offer->html_key_feature_2) ? 'NIL' : $offer->html_key_feature_2,
            'Key Icon 2' =>  $offer->key_icon_2,
            'Description' => empty($offer->html_description) ? 'NIL' : $offer->html_description,
