...
class OfferController extends Controller
{
    ...
    public function show(Offer $offer)
    {
        $viewData = [
            ...
            'Key Icon 1' => empty($offer->key_icon_1) ? 'NIL' : url(file_asset('files-offer', $offer->key_icon_1)) ,
            'Key Feature 2' => empty($offer->key_feature_2) ? 'NIL' : $offer->key_feature_2,
            'Key Icon 2' => empty($offer->key_icon_2) ? 'NIL' : url(file_asset('files-offer', $offer->key_icon_2)) ,
