   ...
   */
    public function toArray($request)
    {
        ...
        return [
            ...
            'icon_1'=> $this->key_feature_1 ?($this->key_icon_1 ? file_asset('files-offer', $this->key_icon_1) :'') : '',
            'icon_2'=> $this->key_feature_2 ? ($this->key_icon_2? file_asset('files-offer', $this->key_icon_2) :'') : '',
